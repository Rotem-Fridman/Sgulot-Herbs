...
lib.ssMetadata = [
		{name:"sgulot_atlas_1", frames: [[588,419,80,2],[670,419,80,2],[588,423,80,2],[670,423,80,2],[2023,0,2,71],[1146,428,80,2],[1942,434,80,2],[1942,438,80,2],[1942,442,80,2],[0,1278,541,72],[1942,446,80,2],[1942,450,80,2],[1942,454,80,2],[1942,458,80,2],[2027,0,2,71],[1942,462,80,2],[1942,466,80,2],[1942,470,80,2],[1942,474,80,2],[1942,478,80,2],[1942,482,80,2],[1942,486,80,2],[543,1310,541,72],[1942,490,80,2],[681,1171,616,137],[1086,1310,487,2],[1086,1314,487,2],[1086,1318,487,2],[1086,1322,487,2],[1086,1326,487,2],[681,779,357,303],[1520,434,420,394],[1040,888,335,281],[755,0,495,426],[1252,0,488,432],[0,640,358,455],[1146,434,372,452],[360,640,105,114],[588,292,133,125],[1742,0,233,432],[1520,830,228,436],[588,428,556,349],[0,292,586,346],[360,779,319,497],[1977,0,44,44],[0,0,753,290],[1750,830,154,522]]},
		{name:"sgulot_atlas_2", frames: [[0,0,477,763],[479,0,431,713],[0,765,477,763],[479,715,431,713],[506,1430,438,561],[912,508,464,571],[1452,0,521,494],[912,0,538,506],[1378,508,478,498],[0,1530,504,516],[1401,1008,423,525],[946,1081,453,529],[946,1612,782,295]]},
		{name:"sgulot_atlas_3", frames: [[1264,581,528,704],[560,0,702,601],[1264,0,702,579],[566,603,634,586],[0,0,558,852],[0,854,564,794],[566,1287,528,704],[1096,1287,606,606]]},
		{name:"sgulot_atlas_4", frames: [[0,0,835,633],[837,0,835,633],[0,635,631,818],[1266,635,604,792],[633,635,631,818]]},
		{name:"sgulot_atlas_5", frames: [[0,1334,835,633],[837,1334,835,633],[750,0,835,670],[750,672,835,660],[0,0,748,888]]},
		{name:"sgulot_atlas_6", frames: [[0,0,917,920],[910,922,1018,675],[919,0,1018,665],[0,922,908,846]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.text.parent = this;
	this.text.setTransform(8.65,-17.15);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_15 = new lib.CachedBmp_178();
	...
	this.instance_18 = new lib.CachedBmp_180();
	...
	this.instance_30 = new lib.CachedBmp_185();
	...
	this.instance_34 = new lib.CachedBmp_186();
	...
	this.instance_37 = new lib.CachedBmp_187();
	this.instance_37.setTransform(-150.55,-262.9,0.4353,0.4353);

	this.instance_38 = new lib.CachedBmp_189();
	...
	this.instance_51 = new lib.CachedBmp_192();
	...
	this.instance_54 = new lib.CachedBmp_193();
...
if (reversed == null) { reversed = false; }
	...
	this.text_7 = new cjs.Text("הופק במסגרת הקורסים ״ארגון וייצוג ידע״ ו״מבוא לתכנות אינטראקציה ואנימציה״", "20px 'Assistant'");
	this.text_7.textAlign = "right";
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/CachedBmp_103.png?1602432906385", id:"CachedBmp_103"},
		{src:"images/CachedBmp_180.png?1602432906385", id:"CachedBmp_180"},
		{src:"images/CachedBmp_178.png?1602432906385", id:"CachedBmp_178"},
		{src:"images/CachedBmp_176.png?1602432906385", id:"CachedBmp_176"},
		{src:"images/CachedBmp_174.png?1602432906385", id:"CachedBmp_174"},
		{src:"images/CachedBmp_172.png?1602432906385", id:"CachedBmp_172"},
		{src:"images/CachedBmp_50.png?1602432906385", id:"CachedBmp_50"},
		{src:"images/hit_logo_new.png?1602432906385", id:"hit_logo_new"},
		{src:"images/sgulot_atlas_1.png?1602432906212", id:"sgulot_atlas_1"},
		{src:"images/sgulot_atlas_2.png?1602432906213", id:"sgulot_atlas_2"},
		{src:"images/sgulot_atlas_3.png?1602432906213", id:"sgulot_atlas_3"},
		{src:"images/sgulot_atlas_4.png?1602432906213", id:"sgulot_atlas_4"},
		{src:"images/sgulot_atlas_5.png?1602432906213", id:"sgulot_atlas_5"},
		{src:"images/sgulot_atlas_6.png?1602432906213", id:"sgulot_atlas_6"}
	],
	preloads: []
};
